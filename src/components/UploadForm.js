...
const {addData, storeFiles, storeFile, storePdfFile} = bookContext;
        ...
        <div style={{ backgroundColor: "aliceblue" }} className="col">
            <div className="form-style-2 offset-4 row-8">
                ...
                <form action="" method="" onSubmit={onFormSubmit}>
                    ...
                    <label for="field6"><span>Choose Img</span><input className="file-input" onChange={(e) =>fileEvent(e)} type="file" id="input"></input>  </label>

                    <label for="field7"><span>Choose pdf</span><input className="file-input" onChange={(e) => PdfStore(e)} type="file" id="input"></input>  </label>

                    <label for="field8"><span>Add website</span><input value={website} className="add-url" placeholder="add URL" onChange={websiteEvent} type="url"></input></label>

                    <label for="field9"><span>Description</span><textarea value={description} onChange={descriptionEvent} name="field5" className="textarea-field"></textarea></label>
